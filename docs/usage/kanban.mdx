...
description: "Use CodeVibe Kanban to run multiple coding agents in parallel with isolated git worktrees."
---
...
- CodeVibe CLI installed (`npm install -g codevibe`)
...
Kanban is designed for CLI-style coding agents and currently works with CodeVibe CLI, Claude Code, Codex, OpenCode, and related runtimes available in settings.
