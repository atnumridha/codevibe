...
title: "TUI"
sidebarTitle: "TUI"
description: "Use CodeVibe's terminal UI (TUI) for interactive coding workflows in your terminal."
---

## What is the TUI?

The TUI is CodeVibe's interactive terminal interface. It is designed for conversational, in-terminal work: ask questions, review plans, approve actions, and iterate quickly.
