...
description: "The full CodeVibe harness: built-in tools, sessions, approvals, scheduling, and hub support."
---

`ClineCore` is the full CodeVibe harness as a programmable runtime. It gives you everything CodeVibe ships out of the box: built-in tools for files, shell, search, and web; session persistence and message history; tool approval callbacks; local, hub, and remote backends; scheduling and automation APIs; and plugin support.
