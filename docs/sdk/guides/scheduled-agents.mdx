...
## Creating Schedules Programmatically with CodeVibe SDK
...
## Schedule Wizard with CodeVibe CLI

The easiest way to schedule tasks is to use the CodeVibe CLI, if you've already installed it with `npm i -g codevibe`.
