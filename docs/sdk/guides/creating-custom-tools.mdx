...
For working examples of tools in real agents, see the [cli-agent](https://github.com/atnumridha/codevibe/tree/main/apps/examples/cli-agent) (shell tool with zod) and [code-review-bot](https://github.com/atnumridha/codevibe/tree/main/apps/examples/code-review-bot) (multiple tools with completion lifecycle).
...
See the [code-review-bot example](https://github.com/atnumridha/codevibe/tree/main/apps/examples/code-review-bot) for this pattern in a complete application.
