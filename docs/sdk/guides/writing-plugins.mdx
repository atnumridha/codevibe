...
Each bundled skill follows the same directory format as any other [CodeVibe skill](/customization/skills). When the plugin is installed or loaded through `pluginPaths`, CodeVibe discovers those skills automatically.
