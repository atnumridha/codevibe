...
- System instructions that guide CodeVibe's behavior (including [CodeVibe Rules](/customization/cline-rules))
...
If your starting context seems high even for simple prompts, add a compatibility [`.clineignore`](/customization/clineignore) file to exclude dependencies, build artifacts, and other files CodeVibe doesn't need. This can dramatically reduce your baseline token usage.
