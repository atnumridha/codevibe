...
description: "Run CodeVibe with local models using Ollama or LM Studio."
---

Run CodeVibe with local inference on your machine.

## Quick Start

1. Install a local runtime (**Ollama** or **LM Studio**)
2. Start the local server
3. In CodeVibe Settings, select the matching provider
4. Select a local model
5. Enable **Use Compact Prompt** in CodeVibe Settings → Features
...
## Recommended CodeVibe Settings for Local Inference
