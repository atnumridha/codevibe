...
description: "Run Codie with local models using Ollama or LM Studio."
---

Run Codie with local inference on your machine.

## Quick Start

1. Install a local runtime (**Ollama** or **LM Studio**)
2. Start the local server
3. In Codie Settings, select the matching provider
4. Select a local model
5. Enable **Use Compact Prompt** in Codie Settings → Features
...
## Recommended Codie Settings for Local Inference
