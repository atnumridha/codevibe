...
Send a test message in CodeVibe to verify your credentials work correctly with the configured endpoint.
...
Confirm you're signed into the correct CodeVibe organization. Verify your administrator has saved the configuration and that you have the latest version of the CodeVibe extension.
