...
<Tip>
API keys are stored locally in VS Code and are only used by the CodeVibe extension.
</Tip>
</Accordion>
...
Send a test message in CodeVibe to verify your connection works correctly with the LiteLLM proxy.
...
Confirm you're signed into the correct CodeVibe organization. Verify your administrator has saved the LiteLLM configuration and that you have the latest version of the CodeVibe extension.
...
- Regularly update the CodeVibe extension for security patches
