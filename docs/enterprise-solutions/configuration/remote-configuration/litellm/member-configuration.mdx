...
<Tip>
API keys are stored locally in VS Code and are only used by the Codie extension.
</Tip>
</Accordion>
...
Send a test message in Codie to verify your connection works correctly with the LiteLLM proxy.
...
Confirm you're signed into the correct Codie organization. Verify your administrator has saved the LiteLLM configuration and that you have the latest version of the Codie extension.
...
- Regularly update the Codie extension for security patches
