...
<Tip>
API keys are stored locally and are only used by the Codie extension.
</Tip>
...
Send a test message in Codie to verify your API key works correctly with the configured Anthropic endpoint.
...
Confirm you're signed into the correct Codie organization. Verify your administrator has saved the Anthropic configuration and that you have the latest version of the Codie extension.
