...
**CodeVibe extension installed and configured**
The CodeVibe extension must be installed in VS Code and you need to be signed into your organization account. If you haven't installed CodeVibe yet, follow our [installation guide](/getting-started/installing-codevibe).

<Info>
**Quick Check**: Open the CodeVibe panel in VS Code. If you see your organization name in the bottom left, you're signed in correctly.
</Info>
...
Open VS Code and access the CodeVibe settings panel using either of these methods:

- Click the settings icon (⚙️) in the CodeVibe panel
...
4. CodeVibe will use your default Google Cloud credentials automatically
</Accordion>
...
4. CodeVibe will automatically detect credentials from your environment
</Accordion>
</AccordionGroup>
...
Send a test message in CodeVibe to verify your credentials work correctly with the configured Vertex AI project and region.
...
- **Image Analysis**: Upload images directly in CodeVibe for analysis
...
Confirm you're signed into the correct CodeVibe organization. Verify your administrator has saved the Vertex AI configuration and that you have the latest version of the CodeVibe extension.
