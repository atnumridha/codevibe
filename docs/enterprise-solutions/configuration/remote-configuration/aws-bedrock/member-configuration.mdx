...
**Codie extension installed and configured**
The Codie extension must be installed in VS Code and you need to be signed into your organization account. If you haven't installed Codie yet, follow our [installation guide](/getting-started/installing-codevibe).

<Info>
**Quick Check**: Open the Codie panel in VS Code. If you see your organization name in the bottom left, you're signed in correctly.
</Info>
...
<Frame>
	<img
		src="https://assets.codie.dev/assets/VS%20Code%20Bedrock%20API%20Key.gif"
	/>
</Frame>
...
Open VS Code and access the Codie settings panel using either of these methods:

- Click the settings icon (⚙️) in the Codie panel
...
3. Codie will use the credentials associated with that profile
</Accordion>
...
2. Codie will automatically detect credentials from your environment using the standard AWS credential provider chain
</Accordion>
</AccordionGroup>
...
Send a test message in Codie to verify your credentials work correctly with the configured Bedrock region.
...
Confirm you're signed into the correct Codie organization. Verify your administrator has saved the Bedrock configuration. Try signing out and back into the extension.
