...
description: "Configure Single Sign-On (SSO) for CodeVibe Enterprise via WorkOS AuthKit."
---

## Overview
CodeVibe Enterprise integrates with your identity provider (IdP) via **WorkOS AuthKit** for SSO.

This page describes, at a high level, how SSO is set up for CodeVibe Enterprise using WorkOS AuthKit.
...
1) **CodeVibe Dashboard (app.cline.bot compatibility endpoint)**
...
## Using the CodeVibe Dashboard
Use the CodeVibe Dashboard at https://app.cline.bot to:
...
To connect your IdP to CodeVibe Enterprise, configure your identity provider in **WorkOS AuthKit**:
...
CodeVibe Enterprise’s default SSO integration is **via WorkOS**.
...
## Troubleshooting
- **Redirect URI mismatch**: confirm the redirect/callback URL configured in WorkOS matches what was provided during your CodeVibe Enterprise onboarding.
