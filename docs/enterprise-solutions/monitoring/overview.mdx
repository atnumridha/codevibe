...
description: "Optional telemetry and observability for your Codie deployment"
---

Codie includes optional monitoring capabilities for organizations that want to track usage and integrate with their observability infrastructure.

## Monitoring Options

<CardGroup cols={2}> 
  <Card title="Codie Telemetry" icon="chart-simple" href="/enterprise-solutions/monitoring/telemetry">
    Built-in anonymous usage tracking that helps improve Codie (opt-in)
  </Card>
...
Codie includes opt-in telemetry for anonymous usage tracking:
...
Users can enable or disable telemetry in Codie settings. All data is anonymous and does not include code content, file paths, or sensitive information.

See [Codie Telemetry](/enterprise-solutions/monitoring/telemetry) for configuration details.

## OpenTelemetry Integration

For advanced monitoring needs, Codie supports OpenTelemetry's OTLP (OpenTelemetry Protocol) for exporting metrics and logs to your own infrastructure.
...
### When to Use Codie Telemetry
- You want to help improve Codie through anonymous usage data
...
For basic telemetry, enable it in Codie settings. For OpenTelemetry, see the configuration guide.
</Step>
...
All Codie monitoring features are designed with privacy in mind:
