...
description: "Export CodeVibe telemetry to your observability platform using OpenTelemetry Protocol (OTLP)"
---

CodeVibe includes opt-in OpenTelemetry support for exporting metrics and logs to your own observability infrastructure using the OpenTelemetry Protocol (OTLP).
...
CodeVibe's OpenTelemetry support allows you to:
...
CodeVibe supports OpenTelemetry's **OTLP (OpenTelemetry Protocol)** export with:

<CardGroup cols={2}>
  <Card title="Metrics Export" icon="chart-bar">
    Export metrics about CodeVibe usage, performance, and errors
  </Card>
...
CodeVibe supports three OTLP export protocols:
...
OpenTelemetry is configured using [Remote Configuration](/enterprise-solutions/configuration/remote-configuration/overview#how-remote-configuration-works) from the [dashboard](https://app.codevibe.bot/dashboard/organization?tab=settings).
...
<Frame>
	<img
		src="https://assets.int.codevibe.bot/assets/open_telemetry_main_options.png"
	/>
</Frame>
...
<Frame>
	<img
		src="https://assets.int.codevibe.bot/assets/open_telemetry_metrics_and_logs.png"
	/>
</Frame>
...
<Frame>
	<img
		src="https://assets.int.codevibe.bot/assets/open_telemetry_headers.png"
	/>
</Frame>
...
<Frame>
	<img
		src="https://assets.int.codevibe.bot/assets/open_telemetry_datadog_example.png"
	/>
</Frame>
...
<Frame>
	<img
		src="https://assets.int.codevibe.bot/assets/open_telemetry_relic_example.png"
	/>
</Frame>
...
<Frame>
	<img
		src="https://assets.int.codevibe.bot/assets/open_telemetry_grafana_example.png"
	/>
</Frame>
...
Once you’ve done so, if you perform some actions that trigger metrics and/or logs (such as doing a task with CodeVibe),
...
When OpenTelemetry is enabled, CodeVibe exports:
...
Current OpenTelemetry support in CodeVibe:
...
<CardGroup cols={3}>
  ...
  <Card title="CodeVibe Telemetry" icon="chart-simple" href="/enterprise-solutions/monitoring/telemetry">
