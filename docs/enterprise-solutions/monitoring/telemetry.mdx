---
title: "Codie Telemetry"
sidebarTitle: "Codie Telemetry"
description: "Configure usage analytics and event tracking"
---

Codie includes telemetry to help understand usage patterns and improve the product. Users can control whether to share this data.

## What is Codie Telemetry?
...
### Enabling/Disabling Codie Telemetry

Individual users can control telemetry through Codie settings:

1. Open Codie settings
2. Find "Codie Telemetry" toggle
...
When telemetry is enabled, Codie captures:
...
Codie Telemetry **never** includes:
...
<Note>
Even with enterprise configuration, individual users can still disable Codie Telemetry in their local settings.
</Note>

## Enterprise Monitoring Features

For organizations with additional compliance or monitoring requirements, Codie provides:
...
Codie's telemetry is designed with privacy in mind:
