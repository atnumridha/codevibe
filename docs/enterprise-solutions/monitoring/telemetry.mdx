---
title: "CodeVibe Telemetry"
sidebarTitle: "CodeVibe Telemetry"
description: "Configure usage analytics and event tracking"
---

CodeVibe includes telemetry to help understand usage patterns and improve the product. Users can control whether to share this data.

## What is CodeVibe Telemetry?
...
### Enabling/Disabling CodeVibe Telemetry

Individual users can control telemetry through CodeVibe settings:

1. Open CodeVibe settings
2. Find "CodeVibe Telemetry" toggle
...
When telemetry is enabled, CodeVibe captures:
...
CodeVibe Telemetry **never** includes:
...
<Note>
Even with enterprise configuration, individual users can still disable CodeVibe Telemetry in their local settings.
</Note>

## Enterprise Monitoring Features

For organizations with additional compliance or monitoring requirements, CodeVibe provides:
...
CodeVibe's telemetry is designed with privacy in mind:
