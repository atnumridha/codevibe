...
- [Shared Configuration in CodeVibe](#shared-configuration-in-codevibe)
- [Providers](#providers)
  - [AIHubMix](#aihubmix)
  - [AskSage](#asksage)
  - [Baseten](#baseten)
...
## Shared Configuration in CodeVibe

1. Open CodeVibe settings (⚙️).
...
For the full auth flow (IDE + CLI), see [Authorization & Model Selection](/getting-started/authorization#menu).
...
3. In CodeVibe, choose **AIHubMix** and paste the key.
...
3. In CodeVibe, select **AskSage** and enter the key.
...
3. In CodeVibe, choose **Baseten** and paste the key.
...
3. In CodeVibe, select **Cerebras** and enter the key.
...
3. In CodeVibe, select **Dify.ai** and paste your key.
...
3. In CodeVibe, select **Doubao** and paste credentials.
...
3. In CodeVibe, choose **Fireworks AI** and enter the key.
...
3. In CodeVibe, select **GCP Vertex AI** and provide required config values.
...
2. Create an API key.
3. In CodeVibe, select **Groq** and paste the key.
...
3. In CodeVibe, choose **Hicap** and enter the credential.
...
3. In CodeVibe, select **Huawei Cloud MaaS** and add credentials.
...
3. In CodeVibe, select **Hugging Face** and paste the token.
...
3. In CodeVibe, choose **Mistral** and paste the key.
...
3. In CodeVibe, select **Moonshot** and enter the key.
...
3. In CodeVibe, choose **Nebius AI Studio** and provide the credential.
...
3. In CodeVibe, select **NousResearch** and add credentials.
...
3. In CodeVibe, select **Qwen Code** and enter the credential.
...
2. Generate an API key.
3. In CodeVibe, select **Requesty** and paste the key.
...
3. In CodeVibe, choose **SambaNova** and enter credentials.
...
3. In CodeVibe, select **SAP AI Core** and provide required values.
...
2. Generate an API key.
3. In CodeVibe, choose **Together** and paste the key.
...
3. In CodeVibe, select **Vercel AI Gateway** and add the key.

### VS Code Language Model API
VS Code Language Model API support lets CodeVibe use models exposed by the VS Code host environment.
...
3. In CodeVibe, select **VS Code Language Model API**.
...
2. Generate an API key.
3. In CodeVibe, choose **xAI (Grok)** and paste the key.