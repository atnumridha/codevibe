...
- [Shared Configuration in Codie](#shared-configuration-in-codie)
- [Providers](#providers)
  - [AIHubMix](#aihubmix)
  - [AskSage](#asksage)
  - [Baseten](#baseten)
...
## Shared Configuration in Codie

1. Open Codie settings (⚙️).
2. Select your model source from **Model Source**.
...
3. In Codie, choose **AIHubMix** and paste the key.
...
3. In Codie, select **AskSage** and enter the key.
...
3. In Codie, choose **Baseten** and paste the key.
...
3. In Codie, select **Cerebras** and enter the key.
...
3. In Codie, select **Dify.ai** and paste your key.
...
3. In Codie, select **Doubao** and paste credentials.
...
3. In Codie, choose **Fireworks AI** and enter the key.
...
3. In Codie, select **GCP Vertex AI** and provide required config values.
...
2. Create an API key.
3. In Codie, select **Groq** and paste the key.
...
3. In Codie, choose **Hicap** and enter the credential.
...
3. In Codie, select **Huawei Cloud MaaS** and add credentials.
...
3. In Codie, select **Hugging Face** and paste the token.
...
3. In Codie, choose **Mistral** and paste the key.
...
3. In Codie, select **Moonshot** and enter the key.
...
3. In Codie, choose **Nebius AI Studio** and provide the credential.
...
3. In Codie, select **NousResearch** and add credentials.
...
3. In Codie, select **Qwen Code** and enter the credential.
...
2. Generate an API key.
3. In Codie, select **Requesty** and paste the key.
...
3. In Codie, choose **SambaNova** and enter credentials.
...
3. In Codie, select **SAP AI Core** and provide required values.
...
2. Generate an API key.
3. In Codie, choose **Together** and paste the key.
...
3. In Codie, select **Vercel AI Gateway** and add the key.

### VS Code Language Model API
VS Code Language Model API support lets Codie use models exposed by the VS Code host environment.
...
3. In Codie, select **VS Code Language Model API**.
...
2. Generate an API key.
3. In Codie, choose **xAI (Grok)** and paste the key.
