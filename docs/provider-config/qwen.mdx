---
title: "Alibaba Qwen"
description: "Learn how to configure and use Alibaba Cloud's Qwen provider with Codie."
---
...
2.  **Select Model Source:** Choose "Alibaba Qwen" from the "Model Source" dropdown.
...
-   **Usage:** Check the [Alibaba Cloud Bailian Console](https://bailian.console.aliyun.com/) for current usage rates.
