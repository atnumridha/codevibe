---
title: "Z AI (Zhipu AI)"
description: "Learn how to configure and use Z AI's GLM models with CodeVibe. Experience advanced hybrid reasoning, agentic capabilities, and open-source excellence with regional optimization."
---
...
### Configuration in CodeVibe

> See [Authorization & Model Selection](/getting-started/authorization#menu).

1.  **Open CodeVibe Settings:** Click the settings icon (⚙️) in the CodeVibe panel.
...
To use the GLM Coding Plans with CodeVibe:
...
3. **Configure in CodeVibe:** Open CodeVibe settings, select "Z AI" as your provider, and paste your API key into the "Z AI API Key" field.

<Frame>
  <img src="https://storage.googleapis.com/cline_public_images/docs/assets/zAI-provider.png" alt="CodeVibe settings with zAI provider selected and API key field highlighted" />
</Frame>

The setup connects your subscription directly to CodeVibe, giving you access to GLM-4.5's tool-calling capabilities optimized for coding workflows.
