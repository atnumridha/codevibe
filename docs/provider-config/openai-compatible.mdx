...
description: "Learn how to configure CodeVibe with various AI model providers that offer OpenAI-compatible APIs."
---

CodeVibe supports a wide range of AI model providers that offer APIs compatible with the OpenAI API standard. This allows you to use models from providers _other than_ OpenAI, while still utilizing a familiar API interface. This includes providers such as:
...
The key to using an OpenAI-compatible provider with CodeVibe is to configure these main settings:
...
You'll find these settings in the CodeVibe settings panel (click the ⚙️ icon):
...
By using an OpenAI-compatible provider, you can leverage the flexibility of CodeVibe with a wider array of AI models. Remember to always consult your provider's documentation for the most accurate and up-to-date information.
