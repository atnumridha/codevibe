...
4. If you haven't already done so, install VSCode and the CodeVibe extension. Consult the [Getting Started](/getting-started/installing-cline) page for guidance.
