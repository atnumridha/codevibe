...
description: "Set up AWS Bedrock with CodeVibe using IAM Access Key and Secret Key credentials. Best for enterprise environments with established IAM policies."
---
...
2.  Use the JSON editor to add the following policy document:
    ...
    ```
3.  Name the policy (e.g., `CodeVibeBedrockInvokeAccess`) and attach it to your IAM user or role.
