...
title: "Models"
sidebarTitle: "Models"
description: "Available models, pricing tiers, free models, and how model IDs work in the Codie API."
---

The Codie API gives you access to models from multiple providers through a single endpoint. Model IDs follow the `provider/model-name` format, the same convention used by [OpenRouter](https://openrouter.ai).
...
For setup and account flow details, see the [Codie provider guide](/getting-started/codevibe-provider).
...
<CardGroup cols={2}>
  ...
  <Card title="Codie provider" icon="scale-balanced" href="/getting-started/codevibe-provider">
