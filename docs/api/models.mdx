...
For setup and account flow details, see the [CodeVibe provider guide](/getting-started/cline-provider).
...
<CardGroup cols={2}>
  ...
  <Card title="CodeVibe provider" icon="scale-balanced" href="/getting-started/cline-provider">
