...
description: "Create an API key and make your first request to the CodeVibe API in under a minute."
---
...
- A CodeVibe account at the current [app.cline.bot compatibility account console](https://app.cline.bot)
- `curl` or any HTTP client (Python, Node.js, etc.)

## Create an API Key

<Steps>
  <Step title="Sign in to CodeVibe">
    Go to the [app.cline.bot compatibility account console](https://app.cline.bot) and sign in with your account.
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="SDK Examples" icon="code" href="/api/sdk-examples">
    Use the API from Python, Node.js, or the CodeVibe CLI.
  </Card>
</CardGroup>
