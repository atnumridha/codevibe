...
When CodeVibe uses the `use_subagents` tool, it launches independent agents simultaneously. Each one:
...
Each subagent prompt should describe a focused research question. CodeVibe will run them in parallel and synthesize the results.
