...
- Cursor sandbox policy imports from `.cursor/sandbox.json`. Automated installed-VSIX evidence now covers import, default sandbox terminal mode, elevated inline terminal requests, redirect blocking, and git-write denies; keep this item in the manual pass for visible approval UX confirmation.
