...
<Note>
**New to CodeVibe CLI?** This sample assumes you have already completed the [Installation Guide](/getting-started/installing-cline) and authenticated with `codevibe auth`. If you haven't set up CodeVibe CLI yet, please start there first.
</Note>
...
- **CodeVibe CLI** installed and authenticated ([Installation Guide](/getting-started/installing-cline))
