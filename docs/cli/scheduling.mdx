...
Run `codevibe schedule` to open an interactive menu for creating and managing schedules, browsing execution history, and viewing performance statistics. The legacy `cline` command remains available as a compatibility alias.
