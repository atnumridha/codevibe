...
const CodeVibeCommands = {
	...
	PlansRefresh: prefix + ".plans.refresh",
	PlansOpen: prefix + ".plans.open",
	PlansOpenLatest: prefix + ".plans.openLatest",
	PlansOpenFolder: prefix + ".plans.openFolder",
	PlansBuildLocal: prefix + ".plans.buildLocal",
	PlansBuildParallel: prefix + ".plans.buildParallel",
