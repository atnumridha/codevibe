...
`
	...
	beforeEach(async () => {
		...
		// Create .codevibe/hooks subdirectory structure
		tempDir = path.join(baseTempDir, ".codevibe", "hooks")
		await fs.mkdir(tempDir, { recursive: true })
		testHandler = createTestHandler()
		mockMessages = []

		// Mock StateManager to return baseTempDir as workspace root
		// This allows HookFactory to find hooks in baseTempDir/.codevibe/hooks/
