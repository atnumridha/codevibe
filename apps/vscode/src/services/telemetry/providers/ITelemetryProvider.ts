...
export interface ITelemetryProvider {
	 ...
	 * @param name Metric name (e.g., "codevibe.tokens.input")
	 ...
	 * Providers that don't support metrics may implement this as a no-op.
	 * @param name Metric name (e.g., "codevibe.api.duration_seconds")
	 ...
	 * Providers that don't support metrics may implement this as a no-op.
	 * @param name Metric name (e.g., "codevibe.workspace.active_roots")
