...
const CURSOR_SETTINGS_SECTION_QUERIES = new Map<string, string>([
	...
	["cursor-compatibility", "@id:codevibe.compatibility.enabled"],
	["cursor-links", "@id:codevibe.compatibility.deepLinks.enabled"],
	["deep-links", "@id:codevibe.compatibility.deepLinks.enabled"],
	["deeplinks", "@id:codevibe.compatibility.deepLinks.enabled"],
	["retrieval-indexing", "@id:codevibe.compatibility.retrievalIndexing.privacyGate"],
	["indexing", "@id:codevibe.compatibility.retrievalIndexing.privacyGate"],
	["privacy-gate", "@id:codevibe.compatibility.retrievalIndexing.privacyGate"],
	["sandbox", "@id:codevibe.compatibility.sandboxPolicy"],
	["sandbox-policy", "@id:codevibe.compatibility.sandboxPolicy"],
	...
	["browser-evaluate", "@id:codevibe.compatibility.safeBrowserEvaluate.enabled"],
	["safe-browser-evaluate", "@id:codevibe.compatibility.safeBrowserEvaluate.enabled"],
])
