...
export const CODEVIBE_NATIVE_CHAT_AGENT_PARTICIPANT_ID = CODEVIBE_CHAT_SESSION_TYPE
export const CODEVIBE_CHAT_PARTICIPANT_IDS = [CODEVIBE_CHAT_PARTICIPANT_ID, CODEVIBE_NATIVE_CHAT_AGENT_PARTICIPANT_ID] as const
