...
- Use "${mcpDetails.mcpId}" as the server name in the MCP settings JSON.
- Create the directory for the new MCP server before starting installation.
- Make sure you read the user's existing MCP settings JSON before editing it with this new server, to not overwrite any existing servers.
