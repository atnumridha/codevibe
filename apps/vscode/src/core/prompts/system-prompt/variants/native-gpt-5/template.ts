...
- Once you've gained enough context to name the likely files, risks, validation path, and order of operations, architect a detailed plan for how you will accomplish the task. Present the plan to the user using the plan_mode_respond tool.
