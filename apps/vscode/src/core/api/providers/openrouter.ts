		...
		if (!this.client) {
			...
			try {
				this.client = createOpenAIClient({
					...
					defaultHeaders: {
						"HTTP-Referer": "https://github.com/atnumridha/codevibe", // Optional, for including your app on openrouter.ai rankings.
						"X-Title": "CodeVibe", // Optional. Shows in rankings on openrouter.ai.
					},
				})
			} catch (error: any) {
