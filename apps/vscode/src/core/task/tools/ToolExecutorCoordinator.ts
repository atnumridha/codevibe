...
import { BrowserSnapshotToolHandler } from "./handlers/BrowserSnapshotToolHandler"
import { BrowserScreenshotToolHandler } from "./handlers/BrowserScreenshotToolHandler"
...
export class ToolExecutorCoordinator {
	...
	private readonly toolHandlersMap: Record<ClineDefaultTool, (v: ToolValidator) => IToolHandler | undefined> = {
		...
		[ClineDefaultTool.BROWSER]: (v: ToolValidator) => new BrowserToolHandler(v),
		[ClineDefaultTool.BROWSER_SNAPSHOT]: (_v: ToolValidator) => new BrowserSnapshotToolHandler(),
		[ClineDefaultTool.BROWSER_SCREENSHOT]: (_v: ToolValidator) => new BrowserScreenshotToolHandler(),
		...
		[ClineDefaultTool.WEB_FETCH]: (v: ToolValidator) => new WebFetchToolHandler(v),
		[ClineDefaultTool.WEB_SEARCH]: (v: ToolValidator) => new WebSearchToolHandler(v),
