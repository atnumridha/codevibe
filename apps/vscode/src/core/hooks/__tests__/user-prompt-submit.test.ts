...
describe("UserPromptSubmit Hook", function () {
	this.timeout(15000)
	...
	describe("Hook Input Format", () => {
		it("should receive prompt text from user content", async function () {
			...
			const hookPath = path.join(tempDir, ".codevibe", "hooks", "UserPromptSubmit")
...
console.log(JSON.stringify({
  ...
  contextModification: "GLOBAL: Prompt received"
			...
			const workspaceHookPath = path.join(tempDir, ".codevibe", "hooks", "UserPromptSubmit")
