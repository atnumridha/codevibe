 ...
 *
 * Use cases:
 * - Global hooks directory: ~/Documents/CodeVibe/Hooks/
 * - Workspace hooks: /path/to/My Project/.codevibe/hooks/
 * - Legacy workspace hooks: /path/to/My Project/.clinerules/hooks/
 *
 * Examples:
