...
import { DeleteHookRequest, type HooksToggles } from "@shared/proto/cline/file"
...
const CodeVibeHookRow: React.FC<HookRowProps> = ({
	hookName,
	enabled,
	absolutePath,
	isGlobal,
			...
			<div className="flex items-center px-2 py-4 rounded bg-text-block-background max-h-4">
				...
				<div className="flex items-center space-x-2 gap-2">
					<div
						title={
							isWindows
								? "Hook toggling is not yet supported on Windows. Hooks execute when the hook file exists."
								: undefined
						}>
						<Switch
							checked={enabled}
...
export default CodeVibeHookRow
