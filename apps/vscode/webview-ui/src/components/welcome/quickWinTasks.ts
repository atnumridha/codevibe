...
export const quickWinTasks: QuickWinTask[] = [
	{
		...
		description: "Map the repo, risks, and next best fixes",
		icon: "ReviewIcon",
	...
	},
	{
		...
		description: "Explore first, then propose a patch path",
		icon: "PlanIcon",
	...
	},
	{
		...
		description: "Audit diffs, run checks, and close gaps",
		icon: "VerifyIcon",
