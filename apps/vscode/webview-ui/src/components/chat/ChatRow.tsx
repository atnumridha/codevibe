...
function parseLocalPlanCompletion(
	text?: string,
): ClinePlanModeResponse | undefined {
				...
				case "command":
					return [
						...
						<span className="font-bold text-foreground">
							Codie wants to execute this command:
						</span>,
					];
				case "use_mcp_server":
						...
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span style={{ fontWeight: "bold" }}>
									Codie wants to delete this file:
								</span>
							</div>
							<CodeAccordian
								// isLoading={message.partial}
						...
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span className="font-bold">
									Codie wants to create a new file:
								</span>
							</div>
							{backgroundEditEnabled && tool.path && tool.content ? (
								<DiffEditRow
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span className="font-bold">
									Codie wants to search this directory for{" "}
					...
					return (
						<div>
							<div className={HEADER_CLASSNAMES}>
								...
								<span className="font-bold">
									Codie is condensing the conversation:
								</span>
							</div>
			...
			case "say":
				switch (message.say) {
					...
					case "clineignore_error":
						return (
							<ErrorRow errorType="workspace_ignore_error" message={message} />
						);
						...
						return (
							<div className="flex flex-col bg-warning/20 p-2 rounded-xs border border-error">
								...
								<div className="text-foreground opacity-80">
									Codie may have trouble viewing the command's output. Please
			...
			case "ask":
				switch (message.ask) {
							...
							<div>
								<div className={HEADER_CLASSNAMES}>
									...
									<span className="text-foreground font-bold">
										Codie wants to start a new task:
									</span>
								</div>
						...
						return (
							<div>
								<div className={HEADER_CLASSNAMES}>
									<FilePlus2Icon className="size-2" />
									<span className="text-foreground font-bold">
										Codie wants to condense your conversation:
									</span>
								</div>
								<NewTaskPreview context={message.text || ""} />
							</div>
						...
						return (
							<div>
								<div className={HEADER_CLASSNAMES}>
									<FilePlus2Icon className="size-2" />
									<span className="text-foreground font-bold">
										Codie wants to create a support request:
									</span>
								</div>
					...
					case "plan_mode_respond": {
						...
						let selected: string | undefined;
						let localPlanBuild:
							| ClinePlanModeResponse["localPlanBuild"]
							| undefined;
						try {
							const parsedMessage = JSON.parse(
								message.text || "{}",
