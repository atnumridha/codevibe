...
const FEATURE_TIPS: FeatureTipItem[] = [
	{
		text: 'Enable "Double-Check Completion" in settings to have Codie verify its work before finishing a task.',
	},
	{
		text: "Add a project rules file to your workspace root to give Codie project-specific instructions.",
	},
	{
		text: "Switch to Plan Mode to discuss and plan an approach before Codie takes action.",
	},
	{
		text: "Use @ in the chat input to add files, folders, or URLs as context for your task.",
	},
	{
		text: "Set up MCP Servers to give Codie access to external tools and APIs.",
	},
	{
		text: "Codie creates checkpoints after changes - you can always restore to a previous state.",
	},
	{
	...
	{
		text: "Use the quote button to select text from Codie's response and reference it in your reply.",
	},
	{
		text: "You can drag and drop images into the chat to share screenshots with Codie.",
	},
	{
		text: "Codie can browse websites - ask it to test your local dev server in the browser.",
	},
	{
		text: "Use /reportbug to quickly prepare a support report with diagnostic context included.",
	},
	{
 ...
 * Appears after a brief delay and cycles through tips while Codie is thinking.
 */
