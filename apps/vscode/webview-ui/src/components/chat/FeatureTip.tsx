...
const FEATURE_TIPS: FeatureTipItem[] = [
	...
	{
		text: "Set up MCP Servers to give CodeVibe access to external tools and APIs.",
	},
	{
		text: "CodeVibe creates checkpoints after changes - you can always restore to a previous state.",
	},
	{
	...
	{
		text: "Use the quote button to select text from CodeVibe's response and reference it in your reply.",
	},
	{
		text: "You can drag and drop images into the chat to share screenshots with CodeVibe.",
	},
	{
		text: "CodeVibe can browse websites - ask it to test your local dev server in the browser.",
	},
	{
 ...
 * Appears after a brief delay and cycles through tips while CodeVibe is thinking.
 */
