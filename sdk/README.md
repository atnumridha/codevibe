...
<tbody>
<td align="center">
<a href="https://github.com/atnumridha/codevibe/discussions" target="_blank"><strong>Discussions</strong></a>
</td>
<td align="center">
<a href="https://github.com/atnumridha/codevibe/issues" target="_blank"><strong>Issues</strong></a>
</td>
<td align="center">
<a href="https://github.com/atnumridha/codevibe/releases" target="_blank"><strong>Releases</strong></a>
</td>
</tbody>
</table>
</div>

The Codie SDK is a TypeScript framework for building AI agents that can edit files, run shell commands, browse the web, call APIs, and use any custom tool you give them. It is the same engine that powers Codie, packaged as a library you can embed in your own applications.
...
If you use a coding agent (Claude Code, Codex, Codie, etc.), install the SDK skill for the currently published package to give your agent context on the SDK's APIs and best practices.
...
| [VS Code Extension App](apps/examples/vscode) | VS Code extension example that runs Codie sessions over the RPC runtime |
...
The Codie CLI gives you terminal access to the full SDK:
...
# Single prompt
codevibe "Refactor the auth module to use JWT"

# Schedule an agent to run daily
codevibe schedule create "PR summary" --cron "0 9 * * MON-FRI" --prompt "Summarize open PRs"

# Connect a Telegram bot created with @BotFather
codevibe connect telegram -k "$TELEGRAM_BOT_TOKEN"
...
Full documentation lives in the Codie docs tree:

- [Overview](../docs/sdk/overview.mdx) -- SDK concepts and getting started
- [Guides](../docs/sdk/guides/building-an-agent.mdx) -- end-to-end tutorials for common patterns
- [Examples](../docs/sdk/examples.mdx) -- runnable SDK examples
- [Reference](../docs/sdk/reference/cline-core.mdx) -- every method, type, and config option


## Contributing

To contribute to the project, start with our [Contributing Guide](CONTRIBUTING.md) to learn the basics. Use the repository discussions and issues for design notes, bug reports, and feature requests.
