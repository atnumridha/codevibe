...
- First check the [Feature Requests discussions board](https://github.com/atnumridha/codevibe/discussions/categories/feature-requests) for similar ideas
...
1. Clone the repository _(Requires [git-lfs](https://git-lfs.com/))_:
    ```bash
    git clone https://github.com/atnumridha/codevibe.git
    ```
